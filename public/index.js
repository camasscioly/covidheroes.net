...
async function init() {
  ...
  for (const prop in usTimelineRes) {
    ...
    const { new_daily_cases, new_daily_deaths, total_cases, total_deaths, total_recoveries } = usTimelineRes[prop];
    ...
    addEntry(prop, `New Cases: ${new_daily_cases}, New Deaths: ${new_daily_deaths}, Total Cases: ${total_cases}, Total Deaths: ${total_deaths}, Total Recoveries: ${total_recoveries}`, '#dateTable');
  }
}
